...
\[ e_s(c_1,c_2) = \begin{cases} 1.0 & \text{if }(nochord(c_1) \land nochord(c_2)) \lor (root(c_1) = root(c_2) \land quality(c_1) = quality(c_2)) \land bass(c_1) = bass(c_2) \\ 0.0 & \text{otherwise} \end{cases} \]

There are other  At its simplest it has the following form
