...
The octave of these successive notes can be incremented or decremented freely, and the chord is still considered to have a \textit{major} quality. See figure \ref{fig: for a C major chord in root position.
