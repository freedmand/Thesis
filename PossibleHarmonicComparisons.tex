...
To attempt to enhance the power of localized comparisons, \text{n-grams} can be used to count occurrences of chord subsequences. An n-gram is just a sequence of a fixed length $n$, where 2-gram would refer to a sequence of length 2, 3-gram would refer to a sequence of length 3, and so on. Using a sliding window
