...
Chord progression identity is a salient factor in harmonically understanding a song, and preserving notions of local similarity is essential. The following sections detail algorithms that can be used to compare chord progressions, their advantages and disadvantages, and basic experimental results, if any. The following notation will be used:

\begin{align*}
{c1}\text{ and }{c2}     & \text{The chord progressions of two songs, respectively} \\
{c_i}                    & \text{The }i\text{th element of chord progression }c \\
{n1}\text{ and }{n2}     & \text{The length of }{c1}\text{ and }{c2}\text{, respectively} \\
C_d                      & \text{A chord distance function taking as argument two chords and returning a value. Higher scores indicate stronger similarity} \\
t_s                      & \text{A transposition function that takes a chord as an argument and transposes it }s\text{ semitones} \\
\end{align*}
